...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--data_dir', type=str,
                            #default='C:/Users/mevin/fyp_project3/Mover/upload_img/input', help='path to images')
                            default='./upload_img/input', help='path to images')
        ...
        #parser.add_argument('--checkpoints_dir', type=str, default='C:/Users/mevin/fyp_project3/Mover/logs/eyemovement/checkpoints', help='models are saved here')
        parser.add_argument('--checkpoints_dir', type=str, default='../logs/eyemovement/checkpoints', help='models are saved here')
    ...
    def print_options(self, opt):
        ...
        makefolders([opt.checkpoints_dir, opt.test_sample_dir])
