...
parser.add_argument('--dataroot', type=str, default='datasets2/genderchange2/', help='root directory of the dataset')
...
parser.add_argument('--generator_A2B', type=str, default='logs/genderchange@31.03.2022-11_02_55/200/netG_A2B.pth', help='A2B generator checkpoint file')
